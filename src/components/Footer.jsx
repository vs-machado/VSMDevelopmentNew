...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-edge/30 py-12">
      <div className="mx-auto w-full max-w-7xl px-8 lg:px-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="https://wa.me/5569992015092"
              target="_blank"
              rel="noopener noreferrer"
               className="text-dim transition-colors hover:text-accent"
            >
          ...
          {/* Copyright */}
          <p className="text-muted text-[0.7rem] font-mono">
            &copy; 2025 VSM Development. {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
